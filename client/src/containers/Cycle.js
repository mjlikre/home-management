...
import { cycles, currentCycle, specificCycle, salesSummary, editSalesRecord } from "./../actions/operations"
...
class Cycle extends Component {
    ...
    handleCycleList (item) {
        this.props.specificCycle({start_date :item.start_date, end_date : item.end_date}, () => {
    ...
    renderDropDown() {
        if (this.state.list) {
            return this.state.list.data.map((item, index) => {
                if (item.end_date != 0){
                    return(
                        <Dropdown.Item href="#/action-1" onClick ={() => {this.handleCycleList(item)}}>{item.cycle_number}</Dropdown.Item>
                        )
                }
    ...
    renderSummaryBox() {
            ...
            if (this.state.data) {
                return (
                    <tr>
                            ...
                            <th><button onClick = {()=>{this.handleEdit(this.state.data[0])}}>编辑</button></th>
                        </tr>
                )
            }
        }
        handleFinalEdit () {
            ...
            this.props.editSalesRecord({id: this.state.data[0].cycle_id, amount: this.state.amount }, () => {
                this.setState({
                    amount : null,
                    quantity: null,
                    edit: 0
                            ...
                            <div className="row">
                                ...
                                >
                                    ...
                                    <div className = "col-md-2">
                                        ...
                                        <input className = "col-md-12 kjga-input-box" type = "number" value = {this.state.quantity} />
                                    </div>
                                    <div className = "col-md-2">
                                    ...
                                    <div className = "col-md-2">
                                        ...
                                        <div className = "col-md-12">
                                            <GeneralButton type = "primary" buttonName ="编辑" handleClick ={this.handleFinalEdit}/>
                                        </div>
...
export default compose(
    connect(mapStateToProps, { cycles, currentCycle, specificCycle, salesSummary, editSalesRecord })
)(Cycle)